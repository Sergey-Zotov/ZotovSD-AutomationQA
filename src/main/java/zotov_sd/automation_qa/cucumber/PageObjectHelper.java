package zotov_sd.automation_qa.cucumber;

import lombok.SneakyThrows;
import org.openqa.selenium.WebElement;
import org.reflections.Reflections;
import zotov_sd.automation_qa.ui.pages.Page;
...
public class PageObjectHelper {
    ...
    private static <T extends Page> T getPage(String pageName) {
        Set<Class<? extends Page>> allPages = new Reflections("zotov_sd.automation_qa.ui.pages").getSubTypesOf(Page.class);
